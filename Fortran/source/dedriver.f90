...
integer, parameter :: NP=10, numgen=20, numciv=200	!enforce NP>2
real, parameter :: F=0.7, Cr=0.9, tol = 0.05		!enforce 0<F<1, 0<=Cr<=1.  Set tol negative to forget posterior/evidence
