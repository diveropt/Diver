...
int main(int argc, char** argv)
{
  ...
  double result = cdiver(gauss, vector, nPar, 
        lowerbounds, upperbounds, path, nDerived, nDiscrete, discrete, partitionDiscrete,
         ...
         outputSamples, init_pop_strategy, discard_unfit_points, max_init_attempts, max_acceptable_val, 
         seed, context, verbose);
